...
export default function AppShell() {
  ...
  return (
    <div className={theme === 'dark' ? 'dark' : ''}>
      <div className="h-[100dvh] w-full flex flex-col bg-white text-black dark:bg-black dark:text-white overflow-hidden relative md:max-w-lg md:mx-auto md:border-x md:border-gray-200 md:dark:border-gray-800">
        {showTopBar && <TopBar />}
